...
integer :: ii,nv
integer :: inrflg
integer, parameter ::nvgrid=37,nvstrt=78,nvindat=166,nvsound=10
...
DATA INDAT/  &
     ...
     ,'ITRKDUSTIFN','ITRKREGEN','SCMTIME','ISCMX','ISCMY','FRACSAT'      &
     ,'IABCARB'                                                          &
...
IF(GROUP.EQ.'$MODEL_OPTIONS') THEN
 ...
 IF(VR.EQ.'ITRKREGEN')    CALL varseti (VR,ITRKREGEN,NV,1,II,0,1)
